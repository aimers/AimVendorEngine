(function() {
 ...
 sap.ui.base.Object.extend("sap.ui.medApp.service.BaseServiceFacade",
   /** @lends app.home.service.BaseServiceFacade */
   {
    ...
    _get : function(sServicePath, sModelPath, sMeasurePath, fnSuccess, fnError,
      fnGetData) {
     ...
     var _fnSuccess = function(oData) {
      ...
      if (sMeasurePath) {
       _this.oModel.setProperty(sMeasurePath, oPostProcessedData[sMeasurePath
         .slice(1)]);
      }
     ...
     this._executeAjax(sServicePath, _fnSuccess, fnError, "GET", null, true,
       null);
    },
     ...
     * 
     * @param {string}
     *          sServicePath the path to which the service would write the data
     *          upon return.
     */
