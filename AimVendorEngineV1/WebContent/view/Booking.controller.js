        ...
        "sap.ui.medApp.view.Booking",
        {
          ...
          _getVendorBookingHistory : function(fnSuccess) {
            ...
            sap.ui.medApp.global.util
                .loadVendorBookingHistory(param, fnSuccess);
          },
          // _getVendorRules
          // ******************************************
          ...
          handleApprovePress : function(oEvent) {
            ...
            sap.ui.medApp.global.util.acceptBooking(this.oModel
                .getProperty(sPath), this.oLoginDetails.USRNM, fnSuccess,
                fnError);
          },
          // handleRejectPress
          // ******************************************
          handleRejectPress : function(oEvent) {
            ...
            var sPath = oEvent.getSource().getBindingContext().getPath();
            sap.ui.medApp.global.util.cancelBooking(this.oModel
                .getProperty(sPath), this.oLoginDetails.USRNM, fnSuccess,
                fnError);
          },
          ...
          handleAddAppointment : function(oEvent) {
            ...
            _this.oBookingData = _this.oModel.getProperty(oItem
              ...
              _this.Appointmentdialog = new sap.m.Dialog(
                  {
                    ...
                    content : sap.ui.xmlfragment(
                        "sap.ui.medApp.view.AddAppointment", this),
                    beginButton : new sap.m.Button(
                        {
                          ...
                          press : function() {
                            ...
                            var oUserSelection = sap.ui.getCore().byId(
                                "userSelectButton");
                            // Existing User
                            if (oUserSelection.getSelectedButton() === "sbExisting") {

                              if (!_this.validateExistingUser()) {
                                sap.ui.getCore().byId("MessageBox").setVisible(
                                    true);
                                ...
                                sap.ui.getCore().byId("MessageBox").setVisible(
                                    false);
                                sap.ui.getCore().byId("MessageBox").setText("");
                                var oMobile = sap.ui.getCore().byId(
                                    "inputExtMobile");
                                sPath = oMobile.getCustomData()[0].getValue();
                                oData = _this.oModel.getProperty(sPath);
                                var oEntity = _this.getView().byId(
                                    "entitySelect").getSelectedItem();
                                var entityData = _this.oModel
                                    .getProperty(oEntity.getBindingContext()
                                        .getPath());
                                if (entityData) {
                                  oDate = _this.oDate;
                                  oDate = oDate.substring(6, 10) + "/"
                                      + oDate.substring(3, 5) + "/"
                                      + oDate.substring(0, 2) + " 00:00:00";
                                  var param = [ {
                                    "key" : "details",
                                    "value" : {
                                      "VSUID" : _this.oLoginDetails.USRID
                                          .toString(),
                                      "VUTID" : "2",
                                      ...
                                      "RULID" : _this.oBookingData.RULID
                                          .toString(),
                                      "VSEML" : _this.oLoginDetails.USRNM,
                                      "BDTIM" : oDate,
                                      "BTIMZ" : "IST",
                                      "BOSTM" : _this.oBookingData.START
                                          .toString(),
                                      "BOETM" : _this.oBookingData.END
                                          .toString(),
                                      "RTYPE" : "1",
                                      "BTYPE" : "1",
                                      "BNOTE" : ""
                                  ...
                                  this._vendorListServiceFacade = new sap.ui.medApp.service.vendorListServiceFacade(
                                      this.oModel);
                                  this._vendorListServiceFacade
                                      .updateParameters(param, fnSuccess,
                                          fnError, "book");
                              ...
                              if (!_this.validateNewUser()) {
                                ...
                                sap.ui.getCore().byId("MessageBox").setVisible(
                                    false);
                                sap.ui.getCore().byId("MessageBox").setText("");
                                var oFname = sap.ui.getCore()
                                    .byId("inputFname");
                                var oLname = sap.ui.getCore()
                                    .byId("inputLname");
                                var oMobile = sap.ui.getCore().byId(
                                    "inputUserName");
                                var oPassword = sap.ui.getCore().byId(
                                    "inputPassword");
                                var param = [ {
                                  "key" : "details",
                                  "value" : {
                                ...
                                sap.ui.medApp.global.util.getRegisterData(
                                    param, fnSuccess);
                              }
          ...
          userSelectedHandle : function(oEvent) {
            ...
            var sPath = oMobile._oList.getSelectedItem()._oItem
                .getBindingContext().getPath();
              ...
              _this.notifyDialog = new sap.m.Dialog({
                ...
                beginButton : new sap.m.Button({
                  ...
                  press : function() {
                    ...
                    sap.ui.medApp.global.busyDialog.open();
                    sap.ui.medApp.global.util.notifyUser(param, fnSuccess,
                        fnError);
                  }
                }),
                endButton : new sap.m.Button({
