        ...
        "sap.ui.medApp.view.FileUpload",
        {
          ...
          handleDelete : function(oEvent) {
            ...
            var oList = oEvent.getSource(), oItem = oEvent
                .getParameter("listItem"), sPath = oItem.getBindingContext()
                .getPath();
                            ...
                            if ('files' in x) {
                              if (x.files.length == 0 || x.files.length > 1) {
                                ...
                                var fnFileUploadError = function(err) {
                                  sap.ui.medApp.global.busyDialog.close();
                                  sap.m.MessageToast
                                      .show("Erorr occured while uploading file");
                                }
                                ...
                                var fnFileUploadSuccess = function(response) {
                                  ...
                                  sap.ui.medApp.global.util
                                      .updateUserDetails(_this.fnSuccess);
                                };
                                sap.ui.medApp.global.busyDialog.open();
                                sap.ui.medApp.global.util.uploadFile(
                                    _this.oLoginDetails.USRID, new FormData(
